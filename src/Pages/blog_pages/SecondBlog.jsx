                ...
                <div className='grid md:grid-cols-3 gap-3 pr-10'>
                    <div className='col-span-2 grid justify-center gap-2'>
                        ...
                        <div className="flex justify-center md:justify-start gap-6 text-[18px] text-[#646464] mt-8">
                            ...
                            <br />
                            <a
                                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent('https://www.ultraflysolutions.com/SecondBlog')}&quote=${encodeURIComponent('Unlocking Success: Why SEO Is Important in Business and How Leverage It Today!')}&hashtag=${encodeURIComponent('#UltraflySolutions')}`}
                                target="_blank"
